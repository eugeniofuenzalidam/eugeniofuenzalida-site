...
const WORKING_HOURS = [9, 10, 11, 12, 14, 15, 16, 17];
...
export default function BookingCalendar() {
  ...
  const isTimeBusy = (hour: number): boolean => {
    ...
    const slotStart = new Date(
      `${dateStr}T${String(hour).padStart(2, "0")}:00:00-04:00`,
    );
    const slotEnd = new Date(
      `${dateStr}T${String(hour + 1).padStart(2, "0")}:00:00-04:00`,
    );
  ...
  if (bookingStatus === "success") {
    content = (
      <div className="bg-neutral-50 rounded-[2rem] p-10 text-center border border-neutral-100">
        ...
        <p className="text-neutral-500 font-light">
          Recibirás la confirmación en tu calendario.
        </p>
        <button
          onClick={() => {
            setBookingStatus("idle");
    ...
    content = (
      <div className="bg-neutral-50 rounded-[2rem] p-10 border border-neutral-100">
        <h3 className="text-2xl font-medium tracking-tight text-black mb-3 text-center">
          Agendar Hora
        </h3>
        <p className="text-neutral-500 font-light mb-8 text-center">
          ...
          {SERVICES.map((service) => (
            ...
            >
              <div className="flex-1 text-left">
                ...
                <div className="text-neutral-500 font-light text-sm mt-1">
                  ${(SERVICE_PRICES[service] || 0).toLocaleString("es-CL")}
                </div>
              </div>
              <button
    ...
    content = (
      <div className="bg-neutral-50 rounded-[2rem] p-10 border border-neutral-100">
        ...
        <div className="flex items-center justify-between mb-6">
          <button
            onClick={prevMonth}
            className="w-9 h-9 rounded-full border border-neutral-200 flex items-center justify-center text-neutral-600 hover:bg-black hover:text-white transition-colors text-sm"
          >
            ←
          </button>
              ...
              <div className="border-t border-neutral-100 pt-6 space-y-4">
                ...
                >
                  {bookingStatus === "submitting"
                    ...
                    : `Agendar y Pagar: ${selectedDate} de ${MONTHS_ES[currentMonth]} a las ${String(selectedTime).padStart(2, "0")}:00`}
                </button>
